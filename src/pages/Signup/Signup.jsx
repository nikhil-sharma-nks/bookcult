      ...
      {loading ? (
        ...
        <div className='signup-page-container'>
          ...
          >
            ...
            <label for='signup_first_name' className='form-label'>
              First Name
            </label>
            <input
              type='text'
              ...
              required
            />
            <label for='signup_last_name' className='form-label'>
              Last Name
            </label>
            <input
              type='text'
              ...
              required
            />
            <label for='signup_email' className='form-label'>
              Email address
            </label>
            <input
              type='email'
            ...
            <input
              ...
              required
            />
            <label for='signup_password_confirm' className='form-label'>
              Confirm Password
            </label>
            <input
              type='password'
